...
if [ -f "/Users/howard/go/bin/moai" ]; then
	exec "/Users/howard/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/howard/.local/bin/moai" ]; then
	exec "/Users/howard/.local/bin/moai" statusline < "$temp_file"
fi
